...
public class MyauMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private myau.util.shader.impl.GuiButton buttonResetDemo;
    ...
    private myau.util.shader.impl.GuiButton altsButton;
    private boolean field_183502_L;
    private GuiScreen field_183503_M;
    private myau.util.shader.impl.GuiButton modButton;
    ...
    public void initGui()
    {
        ...
        synchronized (this.threadLock)
        {
            ...
            this.field_92021_u = ((myau.util.shader.impl.GuiButton)this.buttonList.get(0)).yPosition - 24;
    ...
    {
        this.buttonList.add(new myau.util.shader.impl.GuiButton(1, this.width / 2 - 100, p_73969_1_, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(new myau.util.shader.impl.GuiButton(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, I18n.format("menu.multiplayer", new Object[0])));

        this.buttonList.add(this.altsButton = new myau.util.shader.impl.GuiButton(14, this.width / 2 + 2, p_73969_1_ + p_73969_2_ * 2, 98, 20, "Alt Manager"));
        this.buttonList.add(this.modButton = new myau.util.shader.impl.GuiButton(6, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, 98, 20, I18n.format("fml.menu.mods", new Object[0])));
    }

    private void addDemoButtons(int p_73972_1_, int p_73972_2_)
    {
        this.buttonList.add(new myau.util.shader.impl.GuiButton(11, this.width / 2 - 100, p_73972_1_, I18n.format("menu.playdemo", new Object[0])));
        this.buttonList.add(this.buttonResetDemo = new myau.util.shader.impl.GuiButton(12, this.width / 2 - 100, p_73972_1_ + p_73972_2_ * 1, I18n.format("menu.resetdemo", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.openGLWarning1 != null && this.openGLWarning1.length() > 0)
        {
            ...
            this.drawString(this.fontRendererObj, this.openGLWarning2, (this.width - this.field_92024_r) / 2, ((myau.util.shader.impl.GuiButton)this.buttonList.get(0)).yPosition - 12, -1);
        }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        if (this.func_183501_a())
        {
            ((IAccessorGuiScreen) this.field_183503_M).callMouseClicked(mouseX, mouseY, mouseButton);
        }
    }
